    ...
    <div className="container" >
      <Card style={{ minWidth: '100%', minHeight: '100vh', display:"flex" }}>
        <div style={{ alignItems: "center",textAlign:"center" }}>
          ...
          <Card.Title><h5 style={{fontWeight: 'bold', fontSize:"50px"}}>Login</h5></Card.Title>
        </div>
        ...
        <div className="row">
          <div className="col-6" >
            <form action="" className="m-5" style={{ display:"block",  alignItems: "center", justifyContent: "center"}}>
              ...
              <br />
              <br />
              <div style={{textAlign:"center" }}><Button >Cadastrar</Button></div>
          ...
          <div className="col-6">
            <div className="car m-5">
              ...
              <Card.Body >
                ...
                <Button className="button is-large" onClick={() => signIn()}>  <span className="icon is-medium">
                  ...
                  <span>Entrar Ultilizando Redes Sociais</span></Button>
              </Card.Body>
